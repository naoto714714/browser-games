...
class AudioManager {
    ...
    playBGM() {
        ...
        const melody = [
            659, 659, 0, 659, 0, 523, 659, 0, 784, 0, 0, 392, 0, 0,
            523, 0, 0, 392, 0, 0, 330, 0, 0, 440, 0, 494, 0, 466, 0,
    ...
    playStomp() { this.playSound('stomp'); }
    playBreak() { this.playSound('break'); }
    playPowerUp() { this.playSound('powerUp'); }
    playDie() { this.playSound('die'); }
    playOneUp() { this.playSound('oneUp'); }
}
