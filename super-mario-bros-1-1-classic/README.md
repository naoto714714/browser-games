...
スーパーマリオブラザーズの記念すべき1-1ステージをクラシック志向で完全再現したブラウザゲームです。既存の1-1ディレクトリとは別に、原作のテンポ感とレベルテンポを重視した決定版として用意しました。

## 🎮 ゲーム概要

オリジナルのスーパーマリオブラザーズ1-1を可能な限り忠実に再現。ブロック配置、敵の位置、物理演算まで細部にこだわり、原作通りのプレイフィールを目指しています。

### 🌟 主な特徴

- **完全な1-1再現**: オリジナルと同じレベルレイアウトとギミック
...
1. [ゲームページ](../super-mario-bros-1-1-classic/) にアクセス
2. スペースキーでゲーム開始
3. 矢印キーで移動、スペースでジャンプ
4. 楽しくプレイ！
