    ...
    constructor() {
        this.events = [
            new GameEvent(
                ...
                'クリック報酬 ×10！',
                {
                    start: () => { this.clickMultiplier = 10; },
                    end: () => { this.clickMultiplier = 1; }
                },
                30,
                0.05 // 5%の確率
            ),
            new GameEvent(
                ...
                'SLvアップグレードコスト半減！',
                {
                    start: () => { this.upgradeCostMultiplier = 0.5; },
                    end: () => { this.upgradeCostMultiplier = 1; }
                },
                60,
                0.03 // 3%の確率
            ),
            new GameEvent(
                ...
                '放置収益 ×5！',
                {
                    start: () => { this.idleMultiplier = 5; },
                    end: () => { this.idleMultiplier = 1; }
                },
                45,
                0.04 // 4%の確率
            ),
