class DrumsAudio {
    ...
    playTom(pitch = 'mid') {
        ...
        const clickBuffer = this.audioContext.createBuffer(1, this.audioContext.sampleRate * 0.005, this.audioContext.sampleRate);
...
class Drums extends Instrument {
    constructor(container, audio) {
        ...
        this.drumConfig = [
            { type: 'hihat', label: 'Hi-Hat', key: 'q', method: () => this.drumsAudio.playHihat() },
            { type: 'snare', label: 'Snare', key: 'w', method: () => this.drumsAudio.playSnare() },
            { type: 'tom1', label: 'Tom 1', key: 'e', method: () => this.drumsAudio.playTom('high') },
            { type: 'kick', label: 'Kick', key: 'space', method: () => this.drumsAudio.playKick() },
            { type: 'tom2', label: 'Tom 2', key: 'a', method: () => this.drumsAudio.playTom('mid') },
            { type: 'tom3', label: 'Tom 3', key: 's', method: () => this.drumsAudio.playTom('low') }
        ];
